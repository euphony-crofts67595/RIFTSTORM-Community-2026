...
# 🎮 RIFTSTORM — Community Edition

**Contain the rift. Play offline, anytime.**
...
RIFTSTORM is a co-op top-down action RPG set in a supernatural world where elite operatives contain reality-breaking rifts. This Community Edition is a standalone build of the game, packaged as a self-contained release that requires no storefront and no additional software. The build is ready to play immediately and supports offline play, with LAN and direct P2P connection available for multiplayer sessions.

This build is for PC players who want a self-contained, offline-ready version of RIFTSTORM for solo or small-group co-op play.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2282790/74659035b04c1325cbd8b15a360b3249ff3b529c/ss_74659035b04c1325cbd8b15a360b3249ff3b529c.1920x1080.jpg?t=1786591238" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2282790/448924dec4f5a40acea6f00417c7e338d4e4d8f3/ss_448924dec4f5a40acea6f00417c7e338d4e4d8f3.1920x1080.jpg?t=1786591238" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2282790/7591b20a762f0c355a280656bceaf81d7160ac2e/ss_7591b20a762f0c355a280656bceaf81d7160ac2e.1920x1080.jpg?t=1786591238" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Portuguese-Brazil, Russian, Japanese, Korean, Simplified Chinese
- **Voiceover:** English
...
- 🧨 **Top-Down Action Combat** — Fast, skill-driven encounters against supernatural entities across collapsing rift zones.
- 👥 **Co-op for Up to 4 Players** — Team-based missions with LAN and direct P2P connection supported.
- 🎭 **Operative Classes** — Distinct playable operatives, each with unique abilities, weapons, and progression paths.
- 🌀 **Rift Incursions** — Mission-based operations with shifting layouts and escalating threat levels.
- 🎁 **Loot and Gear Progression** — Collect, upgrade, and customize weapons, mods, and equipment across runs.
- 🌐 **Offline Mode** — A self-contained package that runs fully offline with no storefront required.
- 📈 **Persistent Advancement** — Long-term progression systems for operatives, gear, and unlockable content.
- 🔊 **Full Audio Presentation** — Complete soundtrack and voice work included in the build.
- 🖥️ **All Content Included** — This independent release includes all content of the base game in one package.

- **Compression:** Lossless
- **Install Time:** ~10 minutes on SSD, ~25 minutes on HDD
- **Recoding:** none
- **Selective Download:** Optional voice-over and bonus content packs can be skipped during installation to reduce footprint

---

## 📦 DLCs Included

- Founder's Operative Pack
- Occult Weapons Bundle
- Original Soundtrack
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1060 6GB or AMD Radeon RX 580 | NVIDIA GeForce RTX 3060 or AMD Radeon RX 6600 XT |
| **Storage** | 30 GB available space | 40 GB available space on SSD |
| **Additional** | DirectX 12 compatible system | Broadband connection only required for direct P2P or LAN sessions |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\RIFTSTORM\Saved`
